...
public class UI {
    ...
    public void printMenu() {
        ...
        System.out.println("6. Reafiseaza comenzile.");
    ...
    public static class ecInvalidLowGroup {
        int highMargin = 99;
    }

    public static class ecInvalidHighGroup {
        int highMargin = 1000;
    }

    public static class ecInvalidFormatGroup {
        String group = "A";
    }
...
//        addNotaValid();
    ...
    public void run() {
        ...
        printMenu();
        while(cmd != 0) {
            System.out.println("Introduceti comanda (6 pentru a reafisa comenzile): ");
            cmd = scanner.nextInt();
